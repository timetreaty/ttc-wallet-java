...
public interface GameApiService {
	...
	// 查角色是否存在
	List<GameApiRoleInfo> findGameRoleExit(String roleId, String roleName, String serverId, Integer gameId,
			Integer userId);
	...
	// 下单
	GameApiDemandOrder playAnBidtOrder(String billNo, String goodsName, double bidtNum, Integer userId, String totalFee,
			Integer gameId);
	...
	// 获取订单状态
	List<GameApiDemandOrder> getOrderStateByAppId(Integer id, String billNo);
	
	
	List<GameApiDemandOrder> getOrderBybillNo(String billNo);
